...
mkvirtualenv: ## create the project environment
	@python3 -m venv "$$WORKON_HOME/alphamale-tour-guide"
	@. "$$WORKON_HOME/alphamale-tour-guide/bin/activate"
	@pip install --upgrade pip setuptools wheel

mkvirtualenv-system: ## create the project environment with system site packages
	@python3 -m venv "$$WORKON_HOME/alphamale-tour-guide" --system-site-packages
	@. "$$WORKON_HOME/alphamale-tour-guide/bin/activate"
	@pip install --upgrade pip setuptools wheel
